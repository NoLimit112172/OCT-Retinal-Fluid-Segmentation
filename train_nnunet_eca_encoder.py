...
from model_nnunet_eca_encoder import nnUNet
...
# 实验 2：nnU-Net + ECA-Encoder，单独目录，避免覆盖 base 结果
CHECKPOINT_DIR = 'checkpoints_nnunet_eca_encoder'
...
def train():
    print(f'🔥 [nnU-Net + ECA-Encoder] 准备训练... 设备: {DEVICE}')
    ...
    if RESUME and os.path.exists(LAST_CKPT_PATH):
        ...
        print('🆕 从头开始训练新的 nnU-Net + ECA-Encoder 实验。')
