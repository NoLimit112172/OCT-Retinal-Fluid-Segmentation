...
MODELS_TO_EVALUATE = [
    {"name": "SegNet", "group": "Baseline", "module": "model_segnet", "class": "SegNet", "fallback_classes": [], "args": {"n_channels": 1, "n_classes": NUM_CLASSES}, "path": "checkpoints_dicece_segnet/best_model.pth"},
    {"name": "U-Net", "group": "Baseline", "module": "model", "class": "UNet", "fallback_classes": [], "args": {"n_channels": 1, "n_classes": NUM_CLASSES}, "path": "checkpoints_dicece_unet/best_model.pth"},
    {"name": "Attention U-Net", "group": "Baseline", "module": "model_attention", "class": "AttentionUNet", "fallback_classes": [], "args": {"n_channels": 1, "n_classes": NUM_CLASSES}, "path": "checkpoints_dicece_attention/best_model.pth"},
    {"name": "DeepLabV3+", "group": "Baseline", "module": "model_deeplabv3plus", "class": "DeepLabV3Plus", "fallback_classes": ["DeepLabv3Plus", "DeepLabV3plus"], "args": {"n_channels": 1, "n_classes": NUM_CLASSES}, "path": "checkpoints_dicece_deeplabv3plus/best_model.pth"},
    {"name": "nnU-Net Base", "group": "Baseline", "module": "model_nnunet_base", "class": "NNUNetBase", "fallback_classes": ["nnUNet"], "args": {"n_channels": 1, "n_classes": NUM_CLASSES}, "path": "checkpoints_nnunet_base/best_model.pth"},
]
...
def main():
    run_by_dataset_evaluation(
        ...
        out_csv="baseline_models_by_dataset_oldstyle.csv",
        chart_prefix="baseline_models_by_dataset",
        title_prefix="五个基线模型对比"
    )
